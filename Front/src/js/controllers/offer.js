(function() {
  ...
  angular.module('app')
    .controller('OfferCtrl', [
        '$scope', '$mdDialog', '$timeout', 'Offer',
        OfferCtrl
    ]);

function OfferCtrl($scope, $mdDialog, $timeout, Offer) {
    $scope.app.subtitle = 'Offer';
    ...
    $scope.getList = function () {
        $scope.promise = Offer.get($scope.query, success).$promise;
    };
    ...
    $scope.editItem = function (ev, item) {
        $mdDialog.show({
            ...
            controller: ['$scope', '$mdDialog', 'Offer', editItemCtrl],
            controllerAs: 'ctrl',
            focusOnOpen: false,
    ...
    $scope.deleteItem = function (ev, item) {
        $mdDialog.show({
            ...
            controller: ['$mdDialog', 'Offer', deleteCtrl],
            controllerAs: 'ctrl',
            focusOnOpen: false,
            targetEvent: ev,
            locals: { item: item },
...
function deleteCtrl($mdDialog, Offer) {
    this.title = "delete";
    ...
    function deleteItem(item) {
        var deferred = Offer.remove({id: item.id});
