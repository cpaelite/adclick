...
!function (e, n) {
    ...
    e.fn.fullpage = function (l) {
        function s() {
            l.css3 && (l.css3 = bn()), l.scrollBar = l.scrollBar || l.hybrid, Q(), Z(), Wn.setAllowScrolling(!0), Wn.setAutoScrolling(l.autoScrolling, "internal");
            var n = e(b).find(z);
        ...
        function N() {
            ne.on("scroll", ve).on("hashchange", Ve).blur(je).resize($e), te.keydown(We).keyup(Ye).on("click touchstart", E + " a", Ke).on("click touchstart", X, Qe).on("click", O, qe), e(y).on("click touchstart", j, Ne), l.normalScrollElements && (te.on("mouseenter", l.normalScrollElements, function () {
                Wn.setMouseWheelScrolling(!1)
            }), te.on("mouseleave", l.normalScrollElements, function () {
                Wn.setMouseWheelScrolling(!0)
            }))
        }
        ...
        function $(n, t, o) {
            var i = 100 * o, r = 100 / o;
            t.wrapAll('<div class="' + V + '" />'), t.parent().wrap('<div class="' + P + '" />'), n.find(W).css("width", i + "%"), o > 1 && (l.controlArrows && se(n), l.slidesNavigation && mn(n, o)), t.each(function (n) {
        ...
        function ve() {
            ...
            if (!l.autoScrolling || l.scrollBar) {
                ...
                if (me(i) && (e(b).hasClass(m) || e(b).addClass(m).siblings().removeClass(m)), n = e(s).eq(r), !n.hasClass(p)) {
                    ...
                    if (S.length)var w = S.data("anchor"), T = S.index();
                    Zn && (n.addClass(p).siblings().removeClass(p), e.isFunction(l.onLeave) && l.onLeave.call(f, u, g, h), e.isFunction(l.afterLoad) && l.afterLoad.call(n, v, g), Re(n), rn(v, g - 1), l.anchors.length && (qn = v, gn(T, w, v, g))), clearTimeout(ot), ot = setTimeout(function () {
                        lt = !1
                    }, 100)
                }
        ...
        function Se(e, n) {
            if (_n.m[e]) {
                var t, o;
                if ("down" == e ? (t = "bottom", o = Wn.moveSectionDown) : (t = "top", o = Wn.moveSectionUp), n.length > 0) {
        ...
        function we(n) {
            ...
            if (!ye(n.target) && be(t)) {
                ...
                if (Zn && !Xn) {
                    var a = En(t);
                    ft = a.y, ut = a.x, i.find(F).length && o.abs(dt - ut) > o.abs(ct - ft) ? o.abs(dt - ut) > ne.outerWidth() / 100 * l.touchSensitivity && (dt > ut ? _n.m.right && Wn.moveSlideRight() : _n.m.left && Wn.moveSlideLeft()) : l.autoScrolling && o.abs(ct - ft) > ne.height() / 100 * l.touchSensitivity && (ct > ft ? Se("down", r) : ft > ct && Se("up", r))
                }
            }
        }
        ...
        function Ae(n, t, o) {
            if ("undefined" != typeof n) {
                ...
                if (!(r.activeSection.is(n) && !Gn || l.scrollBar && ne.scrollTop() === r.dtop && !n.hasClass(L))) {
                    ...
                    l.autoScrolling && l.continuousVertical && "undefined" != typeof r.isMovementUp && (!r.isMovementUp && "up" == r.yMovement || r.isMovementUp && "down" == r.yMovement) && (r = Oe(r)), (!e.isFunction(l.onLeave) || r.localIsResizing || l.onLeave.call(r.activeSection, r.leavingSection, r.sectionIndex + 1, r.yMovement) !== !1) && (ze(r.activeSection), n.addClass(p).siblings().removeClass(p), Re(n), l.scrollOverflowHandler.onLeave(), Zn = !1, gn(s, a, r.anchorLink, r.sectionIndex), Ee(r), qn = r.anchorLink, rn(r.anchorLink, r.sectionIndex))
                }
            }
        }
        ...
        function Be(n) {
            n.wrapAroundElements && n.wrapAroundElements.length && (n.isMovementUp ? e(T).before(n.wrapAroundElements) : e(x).after(n.wrapAroundElements), On(e(b).position().top), Le())
        }
        ...
        function Fe() {
            var e = n.location.hash.replace("#", "").split("/"), t = e[0], o = e[1];
            t && (l.animateAnchor ? pn(t, o) : Wn.silentMoveTo(t, o))
        }

        function Ve() {
            if (!lt && !l.lockAnchors) {
                var e = n.location.hash.replace("#", "").split("/"), t = e[0], o = e[1], i = "undefined" == typeof qn, r = "undefined" == typeof qn && "undefined" == typeof o && !Xn;
                t.length && (t && t !== qn && !i || r || !Xn && Yn != o) && pn(t, o)
            }
        }
        ...
        function We(n) {
            ...
            if (!t.is("textarea") && !t.is("input") && !t.is("select") && "true" !== t.attr("contentEditable") && "" !== t.attr("contentEditable") && l.keyboardScrolling && l.autoScrolling) {
                ...
                e.inArray(o, i) > -1 && n.preventDefault(), Un = n.ctrlKey, rt = setTimeout(function () {
                    Ge(n)
                }, 150)
            }
        }
        ...
        function Ne() {
            ...
            e(this).hasClass(K) ? _n.m.left && Wn.moveSlideLeft(n) : _n.m.right && Wn.moveSlideRight(n)
        }
        ...
        function Ge(n) {
            ...
            switch (n.which) {
                ...
                case 40:
                case 34:
                    _n.k.down && Wn.moveSectionDown();
                    break;
                case 36:
                    _n.k.up && Wn.moveTo(1);
                    break;
                case 35:
                    _n.k.down && Wn.moveTo(e(y).length);
                    break;
                case 37:
                    _n.k.left && Wn.moveSlideLeft();
                    break;
                case 39:
                    _n.k.right && Wn.moveSlideRight();
                    break;
                default:
                    return
            }
        ...
        function Je(e) {
            Zn && (e.pageY < vt && _n.m.up ? Wn.moveSectionUp() : e.pageY > vt && _n.m.down && Wn.moveSectionDown()), vt = e.pageY
        }

        function Ze(n, t) {
            var i = t.position(), r = t.index(), a = n.closest(y), s = a.index(y), c = a.data("anchor"), d = a.find(U), f = wn(t), u = a.find(z), h = Gn;
            if (l.onSlideLeave) {
            ...
            if (l.css3) {
                ...
                en(n.find(W), l.scrollingSpeed > 0).css(Bn(w)), tt = setTimeout(function () {
                    S()
        ...
        function $e() {
            if (_e(), Nn) {
                ...
                if (!n.is("textarea") && !n.is("input") && !n.is("select")) {
                    var i = ne.height();
                    o.abs(i - mt) > 20 * o.max(mt, i) / 100 && (Wn.reBuild(!0), mt = i)
                }
        ...
        function _e() {
            ...
            e && n ? Wn.setResponsive(t || o) : e ? Wn.setResponsive(t) : n && Wn.setResponsive(o)
        }
        ...
        function cn(e) {
            e.addClass(q).wrapInner('<div class="' + C + '" style="height:' + dn(e) + 'px;" />')
        }
        ...
        function pn(e, n) {
            var t = un(e);
            "undefined" == typeof n && (n = 0), e === qn || t.hasClass(p) ? vn(t, n) : Ae(t, function () {
                vn(t, n)
            })
        }
        ...
        function gn(e, n, t, o) {
            var i = "";
            l.anchors.length && !l.lockAnchors && (e ? ("undefined" != typeof t && (i = t), "undefined" == typeof n && (n = e), Yn = n, Sn(i + "/" + n)) : "undefined" != typeof e ? (Yn = n, Sn(t)) : Sn(t)), yn()
        }
        ...
        function xn() {
            ...
            "DOMMouseScroll" == r ? t[e](o + "MozMousePixelScroll", Ce, !1) : t[e](o + r, Ce, !1)
        }

        function Cn() {
            Kn.on("mousedown", Ue).on("mouseup", Xe)
        }

        function kn() {
            Kn.off("mousedown", Ue).off("mouseup", Xe)
        }

        function Ln() {
            if (Nn || jn) {
                var n = An();
                e(a).off("touchstart " + n.down).on("touchstart " + n.down, Te), e(a).off("touchmove " + n.move).on("touchmove " + n.move, we)
            }
        }
        ...
        function In(e, n) {
            Wn.setScrollingSpeed(0, "internal"), "undefined" != typeof n && (Gn = !0), Ze(e.closest(F), e), "undefined" != typeof n && (Gn = !1), Wn.setScrollingSpeed(at.scrollingSpeed, "internal")
        }
        ...
        function Hn(e, n, t) {
            switch (n) {
                ...
                case"right":
                    ...
                    break;
                case"all":
                    "m" == t ? Wn.setAllowScrolling(e) : Wn.setKeyboardScrolling(e)
            }
        }

        function Rn() {
            On(0), e(E + ", " + U + ", " + j).remove(), e(y).css({
                height: "",
                "background-color": "",
                padding: ""
            ...
            }), nn(Kn), Kn.find(k + ", " + W + ", " + F).each(function () {
        ...
        var Fn = e("html, body"), Vn = e("body"), Wn = e.fn.fullpage;
        l = e.extend({
            menu: !1,
            anchors: [],
            lockAnchors: !1,
        ...
        }), Wn.setAutoScrolling = function (n, t) {
            Dn("autoScrolling", n, t);
            var o = e(b);
            l.autoScrolling && !l.scrollBar ? (Fn.css({
                overflow: "hidden",
                height: "100%"
            }), Wn.setRecordHistory(at.recordHistory, "internal"), Kn.css({
                "-ms-touch-action": "none",
                "touch-action": "none"
            }), o.length && On(o.position().top)) : (Fn.css({
                overflow: "visible",
                height: "initial"
            }), Wn.setRecordHistory(!1, "internal"), Kn.css({
                "-ms-touch-action": "",
                "touch-action": ""
            }), On(0), o.length && Fn.scrollTop(o.position().top))
        }, Wn.setRecordHistory = function (e, n) {
            Dn("recordHistory", e, n)
        }, Wn.setScrollingSpeed = function (e, n) {
            Dn("scrollingSpeed", e, n)
        }, Wn.setFitToSection = function (e, n) {
            Dn("fitToSection", e, n)
        }, Wn.setLockAnchors = function (e) {
            l.lockAnchors = e
        }, Wn.setMouseWheelScrolling = function (e) {
            e ? (xn(), Cn()) : (Tn(), kn())
        }, Wn.setAllowScrolling = function (n, t) {
            "undefined" != typeof t ? (t = t.replace(/ /g, "").split(","), e.each(t, function (e, t) {
                Hn(n, t, "m")
            })) : n ? (Wn.setMouseWheelScrolling(!0), Ln()) : (Wn.setMouseWheelScrolling(!1), Mn())
        }, Wn.setKeyboardScrolling = function (n, t) {
            "undefined" != typeof t ? (t = t.replace(/ /g, "").split(","), e.each(t, function (e, t) {
                Hn(n, t, "k")
            })) : l.keyboardScrolling = n
        }, Wn.moveSectionUp = function () {
            var n = e(b).prev(y);
            n.length || !l.loopTop && !l.continuousVertical || (n = e(y).last()), n.length && Ae(n, null, !0)
        }, Wn.moveSectionDown = function () {
            var n = e(b).next(y);
            n.length || !l.loopBottom && !l.continuousVertical || (n = e(y).first()), n.length && Ae(n, null, !1)
        }, Wn.silentMoveTo = function (e, n) {
            Wn.setScrollingSpeed(0, "internal"), Wn.moveTo(e, n), Wn.setScrollingSpeed(at.scrollingSpeed, "internal")
        }, Wn.moveTo = function (e, n) {
            var t = un(e);
            "undefined" != typeof n ? pn(e, n) : t.length > 0 && Ae(t)
        }, Wn.moveSlideRight = function (e) {
            ke("next", e)
        }, Wn.moveSlideLeft = function (e) {
            ke("prev", e)
        }, Wn.reBuild = function (n) {
            if (!Kn.hasClass(f)) {
                ...
                o && Wn.silentMoveTo(o + 1), Gn = !1, e.isFunction(l.afterResize) && n && l.afterResize.call(Kn), e.isFunction(l.afterReBuild) && !n && l.afterReBuild.call(Kn)
            }
        }, Wn.setResponsive = function (n) {
            var t = Vn.hasClass(c);
            n ? t || (Wn.setAutoScrolling(!1, "internal"), Wn.setFitToSection(!1, "internal"), e(E).hide(), Vn.addClass(c)) : t && (Wn.setAutoScrolling(at.autoScrolling, "internal"), Wn.setFitToSection(at.autoScrolling, "internal"), e(E).show(), Vn.removeClass(c))
        };
        var qn, Yn, Un, Xn = !1, Nn = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/), jn = "ontouchstart"in n || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints, Kn = e(this), Qn = ne.height(), Gn = !1, Jn = !0, Zn = !0, $n = [], _n = {};
    ...
    var ie = {
        refreshId: null, iScrollInstances: [], onLeave: function () {
            ...
            "undefined" != typeof n && n.wheelOff()
        }, afterLoad: function () {
            var n = e(b).find(s).data("iscrollInstance");
            "undefined" != typeof n && n.wheelOn()
        }, create: function (n, t) {
            var o = n.find(s);
            ...
            if (n.length) {
                var t = n.data("iscrollInstance");
                t.destroy(), n.data("iscrollInstance", i)
            }
