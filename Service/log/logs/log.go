...
func (bl *BeeLogger) writerMsg(loglevel int, msg string) error {
	//fmt.Printf("BeeLogger.writerMsg\tenableFuncCallDepth[%v]\tasynchronous[%v]\t", bl.enableFuncCallDepth, bl.asynchronous)
...
func (bl *BeeLogger) Detail(format string, v ...interface{}) {
	if LevelDetail > bl.level {
		return
	}
	msg := fmt.Sprintf("[Dt] "+format, v...)
	bl.writerMsg(LevelDetail, msg)
}
